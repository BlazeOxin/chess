  ...
  return (
    <div className="dropdown__item ">
      ...
      >
        ...
        >
          <path
            d="M7 8.46154L1 2L5 8.46154L1 14L7 8.46154Z"
            fill="currentColor"
          />
        </svg>
      </button>
...
const TitleBar: React.FC<TitleBarProps> = ({ emitter, menu }) => {
  ...
  React.useEffect(() => {
    ...
    dragbar.style.height = wrapperH - 2 + "px";
  }, []);

  return (
    <div id="tb-wrapper" className={`titlebar__wrapper ${menu.theme}`}>
          ...
          <div key={i} className="main__menu">
            <button
              ...
              className={`menu__label ${
                isOpen && openedMenu === sec.name ? "active" : ""
              }`}
              datatype={sec.name}
            />
      ...
      <div className="app__controls" id="tb-controls">
        ...
        {isMaximized ? (
          <svg
            onClick={() => {
              emitter({ ev: EV.APP_UNMAXIMIZE });
            }}
            viewBox="0 0 32 32"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M5 27V9H23V27H5Z" stroke="currentColor" />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
          ...
          <svg
            onClick={() => {
              emitter({ ev: EV.APP_MAXIMIZE });
            }}
            viewBox="0 0 32 32"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M7 25V7H25V25H7Z" stroke="currentColor" />
          </svg>
        )}
        <svg
